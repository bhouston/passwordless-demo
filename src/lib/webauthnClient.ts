...
function isNodeTestEnv() {
	return (
		...
		document.body?.dataset.nodeEnv === "test"
	);
}

function consumeTestError(
	key: "nextAuthenticationError" | "nextRegistrationError",
) {
	if (!isNodeTestEnv()) {
		return null;
	}
...
export async function startPasskeyRegistration(
	...args: Parameters<typeof startRegistration>
) {
...
export async function startPasskeyAuthentication(
	...args: Parameters<typeof startAuthentication>
) {
