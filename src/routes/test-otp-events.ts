...
import { isTestOtpSseEnabled, registerTestOtpConnection, unregisterTestOtpConnection } from '@/server/testOtpSse';
      ...
      GET: async ({ request }) => {
        ...
        const stream = new ReadableStream<Uint8Array>({
          start(controller) {
            ...
            controller.enqueue(new TextEncoder().encode(eventLine + dataLine));
